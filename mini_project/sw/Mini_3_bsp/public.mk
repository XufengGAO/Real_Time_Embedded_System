...
SOPCINFO_FILE := C:/Users/24833/Desktop/FPGA/miniProject/sdram_instrCacheEnabled_dataCacheEnabled/hw/quartus/system.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x40810a0
SOPC_SYSID_FLAG += --sidp=0x40810a0
ELF_PATCH_FLAG  += --sidp 0x40810a0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1653895687
SOPC_SYSID_FLAG += --timestamp=1653895687
ELF_PATCH_FLAG  += --timestamp 1653895687
