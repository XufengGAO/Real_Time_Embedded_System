...
# Memory: cpu_0_0_SRAM_0
MEM_0 := system_cpu_0_0_SRAM_0
$(MEM_0)_NAME := cpu_0_0_SRAM_0
...
$(MEM_0)_END := 0x2003dfff
$(MEM_0)_SPAN := 0x0001e000
$(MEM_0)_HIERARCHICAL_PATH := cpu_0_0.SRAM_0
$(MEM_0)_WIDTH := 32
$(MEM_0)_HEX_DATA_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: cpu_0_0_SRAM_0
cpu_0_0_SRAM_0: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
