...
(
    ...
    localparam PAD6 = log2ceil(64'h4041080 - 64'h4041070); 
    localparam PAD7 = log2ceil(64'h4041090 - 64'h4041080); 
    localparam PAD8 = log2ceil(64'h4041098 - 64'h4041090); 
    localparam PAD9 = log2ceil(64'h40410a0 - 64'h4041098); 
    localparam PAD10 = log2ceil(64'h40410a8 - 64'h40410a0); 
    localparam PAD11 = log2ceil(64'h40410b0 - 64'h40410a8); 
    localparam PAD12 = log2ceil(64'h40410b8 - 64'h40410b0); 
    // -------------------------------------------------------
    ...
    // ( 0x4041070 .. 0x4041080 )
    if ( {address[RG:PAD6],{PAD6{1'b0}}} == 27'h4041070   ) begin
            src_channel = 22'b0000000010000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 17;
    end

    // ( 0x4041080 .. 0x4041090 )
    if ( {address[RG:PAD7],{PAD7{1'b0}}} == 27'h4041080   ) begin
            src_channel = 22'b0000000000010;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 2;
    end

    // ( 0x4041090 .. 0x4041098 )
    if ( {address[RG:PAD8],{PAD8{1'b0}}} == 27'h4041090   ) begin
            src_channel = 22'b0100000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 18;
    end

    // ( 0x4041098 .. 0x40410a0 )
    if ( {address[RG:PAD9],{PAD9{1'b0}}} == 27'h4041098  && read_transaction  ) begin
    ...
    // ( 0x40410a8 .. 0x40410b0 )
    if ( {address[RG:PAD11],{PAD11{1'b0}}} == 27'h40410a8   ) begin
            src_channel = 22'b0000000000100;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 4;
    end

    // ( 0x40410b0 .. 0x40410b8 )
    if ( {address[RG:PAD12],{PAD12{1'b0}}} == 27'h40410b0   ) begin
