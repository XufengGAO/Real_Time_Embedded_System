...
# Memory: cpu_1_0_SRAM_1
MEM_0 := system_cpu_1_0_SRAM_1
$(MEM_0)_NAME := cpu_1_0_SRAM_1
...
$(MEM_0)_HIERARCHICAL_PATH := cpu_1_0.SRAM_1
$(MEM_0)_WIDTH := 32
$(MEM_0)_HEX_DATA_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: cpu_1_0_SRAM_1
cpu_1_0_SRAM_1: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
