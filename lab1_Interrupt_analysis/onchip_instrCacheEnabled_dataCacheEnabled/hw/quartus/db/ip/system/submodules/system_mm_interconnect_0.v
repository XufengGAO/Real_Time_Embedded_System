...
module system_mm_interconnect_0 (
	...
	wire  [18:0] custom_pio_0_avalon_slave_0_agent_m0_address;                                       // Custom_PIO_0_avalon_slave_0_agent:m0_address -> Custom_PIO_0_avalon_slave_0_translator:uav_address
	...
	wire  [95:0] custom_pio_0_avalon_slave_0_agent_rf_source_data;                                   // Custom_PIO_0_avalon_slave_0_agent:rf_source_data -> Custom_PIO_0_avalon_slave_0_agent_rsp_fifo:in_data
	...
	wire  [95:0] custom_pio_0_avalon_slave_0_agent_rsp_fifo_out_data;                                // Custom_PIO_0_avalon_slave_0_agent_rsp_fifo:out_data -> Custom_PIO_0_avalon_slave_0_agent:rf_sink_data
	...
	wire  [94:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> Custom_PIO_0_avalon_slave_0_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                              // Custom_PIO_0_avalon_slave_0_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [4:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> Custom_PIO_0_avalon_slave_0_agent:cp_channel
	...
	wire         custom_pio_0_avalon_slave_0_agent_rp_valid;                                         // Custom_PIO_0_avalon_slave_0_agent:rp_valid -> router_003:sink_valid
	wire  [94:0] custom_pio_0_avalon_slave_0_agent_rp_data;                                          // Custom_PIO_0_avalon_slave_0_agent:rp_data -> router_003:sink_data
	wire         custom_pio_0_avalon_slave_0_agent_rp_ready;                                         // router_003:sink_ready -> Custom_PIO_0_avalon_slave_0_agent:rp_ready
	wire         custom_pio_0_avalon_slave_0_agent_rp_startofpacket;                                 // Custom_PIO_0_avalon_slave_0_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire         custom_pio_0_avalon_slave_0_agent_rp_endofpacket;                                   // Custom_PIO_0_avalon_slave_0_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire  [94:0] cmd_demux_src4_data;                                                                // cmd_demux:src4_data -> crosser:in_data
	...
	wire  [94:0] crosser_out_data;                                                                   // crosser:out_data -> cmd_mux_004:sink0_data
	...
	wire  [94:0] rsp_demux_004_src0_data;                                                            // rsp_demux_004:src0_data -> crosser_001:in_data
	...
	wire  [94:0] crosser_001_out_data;                                                               // crosser_001:out_data -> rsp_mux:sink4_data
	wire         crosser_001_out_ready;                                                              // rsp_mux:sink4_ready -> crosser_001:out_ready
	wire   [4:0] crosser_001_out_channel;                                                            // crosser_001:out_channel -> rsp_mux:sink4_channel
	...
	wire         custom_pio_0_avalon_slave_0_agent_rdata_fifo_src_valid;                             // Custom_PIO_0_avalon_slave_0_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire  [33:0] custom_pio_0_avalon_slave_0_agent_rdata_fifo_src_data;                              // Custom_PIO_0_avalon_slave_0_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire         custom_pio_0_avalon_slave_0_agent_rdata_fifo_src_ready;                             // avalon_st_adapter_001:in_0_ready -> Custom_PIO_0_avalon_slave_0_agent:rdata_fifo_src_ready
	...
	system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (pll_0_outclk0_clk),                                      // in_clk_0.clk
		.in_rst_0_reset (nios2_gen2_0_reset_reset_bridge_in_reset_reset),         // in_rst_0.reset
		.in_0_data      (custom_pio_0_avalon_slave_0_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (custom_pio_0_avalon_slave_0_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (custom_pio_0_avalon_slave_0_agent_rdata_fifo_src_ready), //         .ready
